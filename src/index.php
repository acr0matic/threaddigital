        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/1.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/2.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/3.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/4.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/5.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/6.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/7.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/8.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/9.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/10.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/11.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/12.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/13.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/14.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
          ...
          <div class="swiper-slide project__slide">
            <div class="project__logo">
              <img class="project__image" src="img/page/main/projects/15.svg" alt="">
            </div>
            <!-- /.project__logo -->
          </div>
          <!-- /.swiper-slide project__slide -->
  ...
  <section id="portfolio" class="section">
    <div class="container">
      ...
      <div class="portfolio">
        ...
        <a class="portfolio__other" href="">
          Другие кейсы
          <svg class="ms-3" width="16" height="25" viewBox="0 0 16 25" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="17.0691" height="4.0161" rx="2.00805" transform="matrix(-0.7114 -0.702787 0.7114 -0.702787 12.5121 14.9101)" fill="white" />
            <rect width="17.0691" height="4.0161" rx="2.00805" transform="matrix(-0.7114 0.702787 0.7114 0.702787 12.5121 9.27338)" fill="white" />
          </svg>
        </a>
      </div>
      <!-- /.portfolio -->
        ...
        <div class="row team__margin">
          <div class="col-6 col-lg-3">
            <div class="team__card team-card">
              ...
              <div class="team-card__name">Грузинский Владислав</div>
          ...
          <div class="col-6 col-lg-3">
            <div class="team__card team-card">
              ...
              <div class="team-card__name">Хмелев Роман</div>
              <div class="team-card__role">Web-дизайнер</div>
          ...
          <div class="col-6 col-lg-3">
            <div class="team__card team-card">
              ...
              <div class="team-card__name">Саблин Никита</div>
              <div class="team-card__role">Motion-дизайнер</div>
          ...
          <div class="col-6 col-lg-3">
            <div class="team__card team-card">
              ...
              <div class="team-card__name">Елизавета Смирнова</div>
              <div class="team-card__role">Руководитель</div>
        ...
        <div class="row">
          <div class="col-6 col-lg-3">
            <div class="team__card team-card">
              ...
              <div class="team-card__name">Дмитриев Дмитрий</div>
              <div class="team-card__role">Технический продюссер</div>
          ...
          <div class="col-6 col-lg-3">
            <div class="team__card team-card">
              ...
              <div class="team-card__name">Артемьева Анастасия</div>
              <div class="team-card__role">SMM-специалист</div>
          ...
          <div class="col-6 col-lg-3">
            <div class="team__card team-card">
              ...
              <div class="team-card__name">Тулин Кирилл</div>
              <div class="team-card__role">Дизайнер</div>
          ...
          <div class="col-6 col-lg-3">
            <div class="team__card team-card">
              ...
              <div class="team-card__name">Косырев Кирилл</div>
              <div class="team-card__role">Старший дизайнер</div>
